...
| 类别 | 技术 | 版本 | 选型理由 |
|------|------|------|----------|
| **后端框架** | FastAPI | >=0.120.0 | 异步高性能，自动API文档 |
| **LLM框架** | LangChain | >=1.2.0 | 成熟的LLM应用开发框架 |
| **工作流引擎** | LangGraph | >=1.0.0 | 状态机工作流，可视化编排 |
| **大模型** | DeepSeek | - | 国产大模型，性价比高 |
| **向量化** | DashScope | - | 阿里云服务，中文效果好 |
| **数据库** | MySQL | 8.0 | 关系数据，事务支持 |
| **缓存** | Redis | 7 | 高速缓存，任务队列 |
